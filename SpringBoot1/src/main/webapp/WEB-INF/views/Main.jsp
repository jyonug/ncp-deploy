				...
				<header id="header" class="alt">
					...
					<nav>
						...
						<c:if test="${not empty member}">
							<c:if test="${member.email eq 'admin'}"> <!-- member가 가지고 있는 email admin과 같니? / eq=equals-->
								<a href="showMember">회원정보관리</a>
							</c:if>
							<c:if test="${member.email ne 'admin'}"> <!-- nq=nor equals -->
					...
					<div class="inner">
						<ul class="links">
							...
							<form action="login" method="post">
								<li><input type="text" name="email" placeholder="Email"을 입력하세요"><li>
								<li><input type="password" name="pw" placeholder="PW"를 입력하세요"><li> <!-- 비밀번호 안보이게 하려면 타입을 text가 아닌 password로 해야함!! -->
								<li><input type="submit" value="Login" calss="button fit"를 입력하세요"><li> </form>
						...
						<ul class="actions vertical">
							...
							<form action="join" method="post">
								...
								<li><span id="resultEmail"></span></li> <!-- 회원가입 가능여부 띄우기 -->
				...
				function checkEmail() {
					...
					$.ajax({
						...
						success : function(res) {
							...
							if(res == "true") {
								$("#resultEmail").text("사용 가능한 이메일입니다.").css("color", "green")
							}else {
